...
MODEL="CodeLlama-7b-hf" # Set the path if you do not want to load from huggingface directly
# ATTENTION: specify the path to your training data, which should be a json file consisting of a list of conversations.
# See the section for finetuning in README for more information.
DATA="../../data/mae_data.json"
...
torchrun $DISTRIBUTED_ARGS ./finetune.py\
    ...
    --data_path $DATA \
    --conv_template tool-codellama2 \
    --bf16 True \
    --output_dir ../../save_model/pkt_model \
    --max_weight 9 \
    --num_train_epochs 1 \
