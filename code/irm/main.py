...
def parse_args():
    ...
    if args.enable_tensorboard:
        ...
        exp_log_dir = f'{args.tensorboard_path}/tensorboard_logs_{TIMESTAMP}'
        print(
    ...
    for epoch in range(args.num_train_epochs):
        ...
        for step, (batch_prompt, batch_unsupervised) in enumerate(
            ...
            if args.save_steps > 0 and global_step % args.save_steps == 0 and args.output_dir is not None:
                ...
                rlhf_engine.actor = convert_lora_to_linear_layer(
                    rlhf_engine.actor)
                rlhf_engine.critic = convert_lora_to_linear_layer(
                    rlhf_engine.critic)
                if args.enable_ema:
                ...
                if args.actor_lora_dim > 0:
                    ...
                    if args.only_optimize_lora:
                        rlhf_engine.actor = only_optimize_lora_parameters(
                            rlhf_engine.actor)
                ...
                if args.critic_lora_dim > 0:
                    ...
                    if args.only_optimize_lora:
                        rlhf_engine.critic = only_optimize_lora_parameters(
                            rlhf_engine.critic)
            ...
            if exp_dataset is not None:
                ...
                for ppo_ep in range(args.ppo_epochs):
                    for i, (exp_data, unsup_data) in enumerate(
                        ...
                        actor_loss, critic_loss, advantage_avged_by_token_and_batch, return_avged_by_token_and_batch = trainer.train_rlhf(
                            exp_data)
                ...
                step_average_ans_len += average_ans_len / \
