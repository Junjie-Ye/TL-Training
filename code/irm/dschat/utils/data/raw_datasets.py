...
class PromptRawDataset(object):
    ...
    def __init__(self, output_path, seed, local_rank, dataset_name):
        ...
        if "boardgame_mix" in dataset_name:
            ...
            self.raw_datasets = load_dataset("json",data_files = dataset_name)
        elif "train_data_code" in dataset_name:
            self.raw_datasets = load_dataset("json",data_files = dataset_name)
        elif "train_data_general" in dataset_name:
            self.raw_datasets = load_dataset("json",data_files = dataset_name)
...
class BoardGameStepWiseDataset(PromptRawDataset):
    def __init__(self, output_path, seed, local_rank, dataset_name):
        super().__init__(output_path, seed, local_rank, dataset_name)
        self.dataset_name = dataset_name
        self.dataset_name_clean = "boardgame_mix_jsonfile"
    ...
    def get_prompt(self, sample):
        # print(sample)
        all_prompt = self.PROMPT_DICT["prompt_no_input"].format(
    ...
    def get_prompt_and_chosen(self, sample):
        ...
        return all_prompt + sample['output']

class BoardGameDataset(PromptRawDataset):
        def __init__(self, output_path, seed, local_rank, dataset_name):
            super().__init__(output_path, seed, local_rank, dataset_name)
            self.dataset_name = dataset_name
            self.dataset_name_clean = "boardgame_jsonfile"
...
class SNLIStepWiseDataset(PromptRawDataset):
    def __init__(self, output_path, seed, local_rank, dataset_name):
        super().__init__(output_path, seed, local_rank, dataset_name)
        self.dataset_name = dataset_name
        self.dataset_name_clean = "snli_mix_jsonfile"
...
class SNLIDataset(PromptRawDataset):
        def __init__(self, output_path, seed, local_rank, dataset_name):
            super().__init__(output_path, seed, local_rank, dataset_name)
            self.dataset_name = dataset_name
            self.dataset_name_clean = "snli_jsonfile"
...
class MNLIStepWiseDataset(PromptRawDataset):
    def __init__(self, output_path, seed, local_rank, dataset_name):
        super().__init__(output_path, seed, local_rank, dataset_name)
        self.dataset_name = dataset_name
        self.dataset_name_clean = "mnli_mix_jsonfile"
...
class MNLIDataset(PromptRawDataset):
        def __init__(self, output_path, seed, local_rank, dataset_name):
            super().__init__(output_path, seed, local_rank, dataset_name)
            self.dataset_name = dataset_name
            self.dataset_name_clean = "mnli_jsonfile"
...
class raceHighStepWiseDataset(PromptRawDataset):
    def __init__(self, output_path, seed, local_rank, dataset_name):
        super().__init__(output_path, seed, local_rank, dataset_name)
        self.dataset_name = dataset_name
        self.dataset_name_clean = "raceHigh_mix_jsonfile"
...
class raceHighDataset(PromptRawDataset):
        def __init__(self, output_path, seed, local_rank, dataset_name):
            super().__init__(output_path, seed, local_rank, dataset_name)
            self.dataset_name = dataset_name
            self.dataset_name_clean = "raceHigh_jsonfile"
...
class GSM8KDataset(PromptRawDataset):
        def __init__(self, output_path, seed, local_rank, dataset_name):
            super().__init__(output_path, seed, local_rank, dataset_name)
            self.dataset_name = dataset_name
            self.dataset_name_clean = "gsm8k_jsonfile"
...
class SVAMPDataset(PromptRawDataset):
        def __init__(self, output_path, seed, local_rank, dataset_name):
            super().__init__(output_path, seed, local_rank, dataset_name)
            self.dataset_name = dataset_name
            self.dataset_name_clean = "svamp_jsonfile"
...
class ToolDataset(PromptRawDataset):
        def __init__(self, output_path, seed, local_rank, dataset_name):
            super().__init__(output_path, seed, local_rank, dataset_name)
            self.dataset_name = dataset_name
            self.dataset_name_clean = "tool_jsonfile"
