...
def print_throughput_step3(actor_model,
    ...
    if rank <= 0:
        ...
        batch_size = args.per_device_generation_batch_size * args.generation_batches * \
            args.ppo_epochs * gpus_per_model * \
            1 if args.unsupervised_dataset_name is None else 2
        samples_per_second = batch_size / e2e_time
        ...
        total_train_flops = actor_train_flops_per_iteration + \
            critic_train_flops_per_iteration
        ...
        total_flops_per_iteration = total_train_flops + \
            gen_flops_per_iteration * args.generation_batches
